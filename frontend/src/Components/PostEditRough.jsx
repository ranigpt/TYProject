...
const PostEditRough= ({ posts, setPosts }) => {
...
const backgroundColors = ["#f9f4f4", "#f3f9f4", "#f4f4fa", "#f9f8f4", "#f4f9f9"]; // Array of light colors for posts.
  ...
  const handleEdit = (post) => {
    console.log("Edit Clicked", post);  // Debugging statement
    setIsEditing(true);
    setCurrentPost(post);
  ...
  return (
    <div className="max-w-4xl mx-auto p-4">
      ...
      {posts.map((post, index) => {
        ...
        console.log("Final User DP Path:", profilePic);
        return (
          <div
          key={post._id}
          className="p-6 rounded-md shadow-lg bg-white mb-6 transition-all hover:shadow-xl"
        >
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              {/* Debugging User DP */}
              {console.log("User DP Path:", profilePic)}
              ...
              <img
                ...
                onError={(e) => {
                  console.error(`Image Load Error for Post ${post._id}:`, e);
                  e.target.src =
            ...
            <div className="mt-4">
              ...
              {newImage ?  (
                ...
                <img
                  src={post.Media}
                  alt="Original Image"
                  className="w-38 h-38 object-contain rounded-md mt-2"
                  />
                </>
              )
              )}
